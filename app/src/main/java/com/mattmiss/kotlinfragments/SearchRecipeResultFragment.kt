...
class SearchRecipeResultFragment : androidx.fragment.app.Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var ingredientsAdapter = CustomListAdapter(ingredientList.context, R.layout.directions_list_view, ingredientsArray, "ingredient")
        ...
        // Set adapter and buttons for Ingredients Layout
        var directionsAdapter = CustomListAdapter(directionList.context, R.layout.directions_list_view, directionsArray, "direction")
