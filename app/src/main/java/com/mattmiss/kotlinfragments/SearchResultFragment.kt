...
import kotlinx.android.synthetic.main.food_search_dialog.*
...
class SearchResultFragment : androidx.fragment.app.Fragment() {
    ...
    companion object {
        fun newInstance(foodJSONString: String, position: Int): SearchResultFragment {
            println("Creating Instance of SearchResultFragment")
            val sf = SearchResultFragment()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val v = inflater.inflate(R.layout.food_search_dialog, container, false)
