package com.mattmiss.kotlinfragments.activities
...
import com.mattmiss.kotlinfragments.fragments.FragmentMyFood
import com.mattmiss.kotlinfragments.fragments.FragmentSearchFood
import com.mattmiss.kotlinfragments.R
import com.mattmiss.kotlinfragments.fragments.FragmentMeals
...
class MainActivity : AppCompatActivity() {
    ...
    private fun selectDrawerItem(item: MenuItem) {
        ...
        val fragmentClass = when (item.itemId) {
            ...
            R.id.thirdFragmentItem -> FragmentMeals::class.java
    ...
    private fun replaceFragment(fragment: androidx.fragment.app.Fragment?) {
        ...
        fragmentTransaction.addToBackStack("replaced_fragment")
