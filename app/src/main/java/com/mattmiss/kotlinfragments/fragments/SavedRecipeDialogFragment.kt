...
class SavedRecipeDialogFragment : androidx.fragment.app.DialogFragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view = inflater!!.inflate(R.layout.recipe_search_dialog, container)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        radioBtnTotalServings.setOnClickListener{
            ...
            setLabels(recipeJSON, numberOfServings)
        }
    ...
    fun setLabels(recipeJSON : JSONObject, servingAmount : Float){
    ...
    companion object {
         ...
         * argument.
         */
        fun newInstance(foodJSON : JSONObject): SavedRecipeDialogFragment {
            val fragmentDialog = SavedRecipeDialogFragment()

             //Supply num input as an argument.
            val args = Bundle()
            args.putString("recipeJSONString", foodJSON.toString())
