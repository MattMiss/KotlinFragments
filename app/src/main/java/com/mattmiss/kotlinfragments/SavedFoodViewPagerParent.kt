...
class SavedFoodViewPagerParent : androidx.fragment.app.DialogFragment(){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnCancelFood.setOnClickListener{
            ...
            savedItemViewModel.delete(tempSavedItem)
            dismiss()
        }
        ...
        var noteAdapter = CustomListAdapter(noteList.context, R.layout.note_list_view, notesArray, "note")
        ...
        var tagAdapter = CustomListAdapter(tagList.context, R.layout.tag_list_view, tagsArray, "tag")
        ...
        // Set adapter and buttons for Notes
        var directionAdapter = CustomListAdapter(directionList.context,
    ...
    fun saveEditedFood(foodJSON: JSONObject){
        ...
        savedItemViewModel.delete(originalObject)
        savedItemViewModel.insert(newObject)
