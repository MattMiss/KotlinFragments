...
class SavedMealListAdapter internal constructor(context: Context, val clickListener: (JSONObject) -> Unit) :
    RecyclerView.Adapter<SavedMealListAdapter.SavedItemHolder>(){
